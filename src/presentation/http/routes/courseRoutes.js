...
const createCourseRoutes = (courseController, authMiddleware) => {
  ...
  router.put('/:id', authMiddleware.protect(), courseController.update.bind(courseController));
  router.delete('/:id', authMiddleware.protect(), courseController.delete.bind(courseController));
