...
const { setupTestDB, teardownTestDB, clearDatabase, createMockStudent, createMockBatch } = require('../helpers/testUtils');
...
describe('Authentication API Endpoints', () => {
  ...
  describe('GET /api/v1/auth/getAllStudents', () => {
    test('should return all students with valid token', async () => {
      ...
      await Student.create(createMockStudent({ batch: batch._id, email: 'student1@test.com' }));
      await Student.create(createMockStudent({ batch: batch._id, email: 'student2@test.com' }));
